...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#84cc16] selection:text-[#0a1931]">
      {/* Top Bar */}
      <div className="bg-[#0a1931] text-white py-2 text-xs md:text-sm">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>+91 8919355294</span>
          </div>
        </div>
      </div>

      {/* Navbar */}
      <nav className="bg-white sticky top-0 z-50 py-4 shadow-md border-b">
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            {/* Increased Logo Size & Removed Text */}
            <img src={LogoImg} alt="Square Health Logo" className="h-20 w-auto object-contain" />
          </div>
          <div className="hidden lg:flex gap-10 font-bold text-[13px] text-[#0a1931] uppercase tracking-wide">
            ...
            <button onClick={() => handleNavClick('contact')} className="bg-[#1E3A8A] text-white px-8 py-3 rounded-lg hover:bg-[#0a1931] transition shadow-md">Book Now</button>
          </div>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-20 items-center">
            ...
            <div className="flex-1">
              <h2 className="text-[#0a1931] text-4xl font-bold mb-8 leading-snug uppercase">Square Medical and Health Care Services</h2>
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p>We are a trusted home healthcare company, dedicated to delivering professional, compassionate, and reliable health care services directly at the doorstep across Hyderabad and Secunderabad.</p>
                <p>Founded by leaders with over 20 years of dedicated background, we bring values of discipline, integrity, and commitment into the healthcare sector.</p>
                <p>With more than 10 years of hands-on experience, we provide comprehensive services in the comfort and privacy of your home.</p>
                <p className="text-[#1E3A8A] font-bold text-xl border-l-4 border-[#84CC16] pl-6 py-2 uppercase">Proudly serving for your good health is our priority.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="home-services" className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-lg font-medium italic">Offering a complete range of professional healthcare solutions at your doorstep, including:</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {homeServices.map((service) => (
              <div key={service.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 flex flex-col hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="p-8 flex-1 flex flex-col justify-center">
                  <h3 className="text-xl font-bold text-[#0a1931] mb-3 uppercase tracking-tight">{service.title}</h3>
      ...
      <section id="b2b-section" className="py-24 bg-[#0a1931] relative">
        <div className="container mx-auto px-6 relative z-10 text-white">
          <div className="text-center mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg font-medium">Customised health check-up packages for corporates and industries through tailored B2B programs.</p>
          </div>
            ...
            {b2bServices.map((service) => (
              <div key={service.id} className="relative group rounded-xl overflow-hidden h-80 shadow-2xl border border-white/10">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <div className="h-1 w-0 group-hover:w-full bg-[#84CC16] transition-all duration-500"></div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {experts.map((member, i) => (
              <div key={i} className="text-center group">
                ...
                <h4 className="font-black text-[#0a1931] text-xl uppercase">{member.name}</h4>
                <p className="text-[#1E3A8A] text-sm font-black mt-2 tracking-widest uppercase">{member.role}</p>
                <div className="text-gray-400 text-[10px] font-bold mt-1 uppercase">{member.specialty}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer id="contact" className="bg-[#050a14] py-20 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-[#84CC16] font-black italic text-xl mb-12">"We Served the Nation... Now We Service the People..."</p>
          <div className="flex flex-wrap justify-center gap-10 mb-12 text-gray-500 font-bold text-xs uppercase tracking-[0.2em]">
          ...
          <div className="text-gray-600 text-[10px] font-bold uppercase tracking-widest border-t border-white/10 pt-10">
